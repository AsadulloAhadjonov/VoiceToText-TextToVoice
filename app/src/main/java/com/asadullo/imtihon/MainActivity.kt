package com.asadullo.imtihon

import com.asadullo.imtihon.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btn.setOnClickListener {
            textToSpeech!!.speak(binding.txt.text.toString(), TextToSpeech.QUEUE_FLUSH, null)
        }
        ...
        questionTextViews[0] = binding.txt
        questionTextViews[1] = binding.txt

        answersTextView = arrayOfNulls(2)

        answersTextView[0] = binding.txt
        answersTextView[1] = binding.txt
    ...
    private fun gen(question: String){
        ...
        if (answer == ""){
            MediaPlayer.create(this, R.raw.hh).start()
        }else {
